...
pdf("fig_2_b.pdf", width = 15/2.54, height = 4/2.54, pointsize = 8)
...
for(cg in cgs) {
  ...
  title(cg, line = 0.5)
  if(cg == cgs[1]) {
    mtext("b", 3, line = 2, font = 2, adj = -0.3)
...
legend("bottom", legend = c("Mono", "TCD4n", "TCD4m"), text.width = strwidth(c("Mono", "TCD4n", "TCD4m")),
       col = cell2col(c("mono", "tcd4n", "tcd4m")), pch = 19, bty = 'n', inset = c(0, 1.15), xpd = NA, horiz = TRUE)
