...
res <- readRDS("data/ewasoverlaps_hannon.rds")
...
pdf("fig_8_b.pdf", width = 15/2.54, height = 0.5 + nlevels(res$pmid)/4.5/2.54, pointsize = 8)
...
mtext("b", 3, adj = 0.04, line = 0.8, font = 2)
