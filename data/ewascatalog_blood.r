...
e <- as.data.frame(read_excel("EWAScatalog/KEPI_A_2289786_SM2258.xls", skip = 5))
...
e <- as.data.frame(read_excel("EWAScatalog/42003_2026_9520_MOESM4_ESM.xlsx", sheet = 2, skip = 3))
